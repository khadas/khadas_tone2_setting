...
public class I2SSettings extends Activity{
	private static final String TAG = "I2SSettings";
			...
			if (arg0.getId() == R.id.write_gpio_btn) {
				...
				try {
					...
					if (productName.equals("kvim1s")) {
						...
						// I2S channel
						os.writeBytes("echo 1 > /sys/class/gpio/gpio" + 503 + "/value\n"); //(PIN35)
						os.writeBytes("echo 0 > /sys/class/gpio/gpio" + 508 + "/value\n"); //(PIN37)
					...
					if (productName.equals("kvim3") || productName.equals("kvim3l")) {
						...
						os.writeBytes("echo 0 > /sys/class/gpio/gpio" + 431 + "/value\n"); //(PIN37)
					...
					if (productName.equals("kvim4")) {
						...
						// I2S channel
						os.writeBytes("echo 1 > /sys/class/gpio/gpio" + 492 + "/value\n"); //(PIN35)
						os.writeBytes("echo 0 > /sys/class/gpio/gpio" + 465 + "/value\n"); //(PIN37)
